...
| 3 | **FUN_0000435a** `param_2` branches | Different update path for arrays 1–2 vs 3–4 | High | FUN_000044a4, entity type | **Partial** (`docs/FUN_0000435a_contract.md`, `param_2_entity_updates` counts; logic not split) |
